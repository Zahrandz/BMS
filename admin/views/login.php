                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7" style="margin:auto;">
                        <div class="card" style="background-color:floralwhite;border-radius:10px">
                            ...
                            <div class="card-body" style="border:2px solid lightseagreen;border-radius:10px">
                                <img src="" alt="homepage" class="dark-logo" style="display:block;margin:auto;height:45px"/>
                                ...
                                <form action="" method="post" class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12" style="background-color:burlywood">
                                            <input type="text" placeholder="enter username" name="username" class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"><b>Password</b></label>
                                        <div class="col-md-12" style="background-color:burlywood">
                                            <input type="password" placeholder="enter password" name="password" class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success float-right" type="submit" name="login" value="login">Sign in</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
